...
//         // Upload the PDF file to Firebase Storage and get its download URL.
...
//         filePath: fileDownloadUrl, // The download URL from Firebase Storage.
...
//                   children: [
//                     // Buttons for uploading or scanning images.
//                     Row(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextField(controller: descriptionController, labelText: 'Description', icon: Icons.description),
                    const SizedBox(height: 20),
                    // New field: Issue Authority (address).
                    CustomTextField(
