  ...
  Future<void> _updateDocument() async {
    ...
    try {
      ...
      QuerySnapshot reminderSnapshot = await FirebaseFirestore.instance
          ...
          .where('documentId', isEqualTo: currentDocument!.documentId)
          .limit(1)
          .get();

      if (reminderSnapshot.docs.isNotEmpty) {
        String reminderId = reminderSnapshot.docs.first.id; // Get reminder ID
      ...
      await NotificationService.updateNotification(currentDocument!.documentId, title, reminderDate);
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        CustomSmallButton(
                            text: 'Upload Images', onPressed: _pickImages),
                        CustomSmallButton(
                            text: 'Scan Documents', onPressed: _scanDocuments),
                      ],
                    ),
