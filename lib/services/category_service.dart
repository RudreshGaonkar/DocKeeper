...
import 'auth_service.dart'; // Ensure this provides the current user's ID
...
class CategoryService {
  ...
  Future<List<Category>> fetchUserCategories() async {
    try {
      final userId = AuthService().currentUserId; // Replace with your method to get the current user's ID
      if (userId == null) {
